export default async function handler(req, res) {
  ...
  const base = [
    'あなたは歯科医院経営の専門コンサルタントです。',
    '以下のふじもと歯科の経営データを分析してください。',
    '',
    summary,
    '',
    '次のJSON形式のみで出力してください。前置きやコードブロックは不要です。',
    '{"overall":"総合評価3行","strengths":["強み1","強み2","強み3"],"issues":[{"title":"課題","detail":"詳細40字","action":"アクション50字"}],"priority":"最優先施策100字"}',
    'issuesは最大4件。JSONのみ出力してください。'
  ].join('\n');
